...
export const projects: Project[] = [
  ...
  },
  {
    ...
    impact: '2B+ Records',
    description: "Led data migration, reconciliation, and analysis projects across all identity platforms. Processed 2B+ records using DuckDB, ClickHouse, and Metabase. Major role in leading data analysts for correction of 500M+ records.",
    stack: ['DuckDB', 'ClickHouse', 'Metabase', 'Node.js Scripts'],
    accent: 'green',
    year: 'Ongoing',
  },
  {
...
export const timeline: TimelineEntry = {
  ...
  items: [
    ...
    { year: 'Ongoing', title: 'Data Migration & Reconciliation', description: 'Led data migration and reconciliation across all identity platforms. Processed 2B+ records using DuckDB, ClickHouse, and Metabase.', color: 'green' },
